'use strict';
var isPlainObject = require('../lodash.js').isPlainObject;
var isFunction = require('../lodash.js').isFunction;
var _find = require('../lodash.js').find;
var _merge = require('../lodash.js').merge;
var _identity = require('../lodash.js').identity;
var _transform = require('../lodash.js').transform;
var _mapValues = require('../lodash.js').mapValues;
var _mapKeys = require('../lodash.js').mapKeys;
var _pick = require('../lodash.js').pick;
var _pickBy = require('../lodash.js').pickBy;
var _keys = require('../lodash.js').keys;
var _each = require('../lodash.js').each;
var _isNil = require('../lodash.js').isNil;
